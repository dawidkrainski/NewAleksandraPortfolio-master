...
const socialData = [
  {
    ...
    label: "Dawid Kraiński",
    to: "https://www.facebook.com/koper112lee",
  },
  {
    logo: <InstagramIcon fontSize="large" />,
    label: "dawid.krainski",
    to: "https://www.instagram.com/dawid_krainski/",
  },
  {
    logo: <LinkedInIcon fontSize="large" />,
    label: "Dawid Kraiński",
    to:
      "https://www.linkedin.com/in/dawidkrainski/",
  },
];
